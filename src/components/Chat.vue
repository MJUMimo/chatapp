<template>
  <div class="wrapper">
    ...
    <nav style="color: white" id="sidebar">
      ...
      <div style="height: 2px; border-bottom: 2px solid #00388b"></div>
      <ul class="list-unstyled components">
        ...
        >
          ...
          <div style="height: 1px; border-bottom: 2px solid #00388b"></div>
        </li>
      </ul>
    </nav>
    ...
    <div id="content" v-if="currentPeerUser===null">
      ...
      <div>
        <h2>ยินดีต้อนรับ {{currentUserName}},</h2>
        <h3>Welcome to Caldavar </h3>
      </div>
    </div>
